...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Developer - Ashish Sharma ❤", url="https://t.me/ashishsharmalegend")],
                [InlineKeyboardButton("Support Group", url="https://t.me/eliteflix_official"),
                 InlineKeyboardButton("Bots Channel", url="https://t.me/eliteflix_bot_backup")],
...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/eliteflix_chat).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/eliteflix_chat).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - Ashish Sharma", url="https://t.me/ashishsharmalegend"), InlineKeyboardButton("Support Group", url="https://t.me/eliteflix_official")], [InlineKeyboardButton("Bots Channel", url="https://t.me/eliteflix_bot_backup")]]),
            disable_web_page_preview=True
        )
        ...
        if (QueueDB.get(cb.from_user.id, None) is None) or (QueueDB.get(cb.from_user.id) == []):
            await cb.answer("Sorry Unkil, Your Queue is Empty!", show_alert=True)
            return
        merged_vid_path = f"{Config.DOWN_PATH}/{str(cb.from_user.id)}/[@Ashishsharmalegend]_Merged.{FormtDB.get(cb.from_user.id).lower()}"
